...
apt-get update
sudo apt-get -y --allow-unauthenticated install unzip zip nginx curl php7.2 php7.2-
mysql php7.2-fpm php7.2-mbstring php7.2-xml php7.2-curl redis-server
...
$config = [
	...
	'settings' => [
		'site_name' => 'Name Site',
		'current_template_folder' => 'maybedrop',
		'site_url' => 'Название домена',
		'steamauth_loginDomen' => 'Название домена',
		'steamauth_apiKey' => '99ED03D2F75DC95ED2FDC17BEC9D93B8',
...
class WebSite {
	...
	public function loadItems() {
		...
		if ($success) {
			echo "ITEMS LIST UPDATED\n";
		} else {
			echo "ERROR ON UPDATE ITEMS LIST: " . $error . "\n";
		}
	}
